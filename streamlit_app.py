...
four_days_ago_df = df_cleared_for_charts[df_cleared_for_charts['Trend Start'].dt.date == three_days_ago.date()].copy()

# Get three days ago's date
five_days_ago = datetime.now() - timedelta(days=5)
five_days_ago_df = df_cleared_for_charts[df_cleared_for_charts['Trend Start'].dt.date == three_days_ago.date()].copy()

# Get three days ago's date
six_days_ago = datetime.now() - timedelta(days=6)
six_days_ago_df = df_cleared_for_charts[df_cleared_for_charts['Trend Start'].dt.date == three_days_ago.date()].copy()
